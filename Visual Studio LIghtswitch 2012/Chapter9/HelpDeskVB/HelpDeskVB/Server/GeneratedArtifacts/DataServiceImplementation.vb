...
Namespace LightSwitchApplication.Implementation
    ...
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.LightSwitch.BuildTasks.CodeGen", "11.0.0.0")> _
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
    Public Class EngineerDataDataService
        Inherits Global.Microsoft.LightSwitch.ServerGenerated.Implementation.DataService(Of Global.EngineerData.Implementation.EngineerDataObjectContext)
        ...
        Protected Overrides Function CreateDataService() As Global.Microsoft.LightSwitch.IDataService
            Return New Global.LightSwitchApplication.DataWorkspace().EngineerData
        End Function
    ...
    <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.LightSwitch.BuildTasks.CodeGen", "11.0.0.0")> _
    <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
    Public Class EngineerDataServiceImplementation
        Inherits Global.Microsoft.LightSwitch.ServerGenerated.Implementation.RiaDataServiceImplementation(Of Global.EngineerData.Implementation.EngineerDataObjectContext, Global.HelpDeskDataServiceVB.EngineerDataService)
    ...
    #Region "Protected methods"
        Protected Overrides Function CreateObject(ByVal type As Global.System.Type) As Object
            If (type Is GetType(Global.EngineerData.Implementation.EngineerRecord)) Then
                Return New Global.EngineerData.Implementation.EngineerRecord
            End If
    
            Return MyBase.CreateObject(type)
        End Function
    
        Protected Overrides Function CreateObjectContext() As Global.EngineerData.Implementation.EngineerDataObjectContext
            Dim assemblyName As String = Global.System.Reflection.Assembly.GetExecutingAssembly().GetName().Name
            Return New Global.EngineerData.Implementation.EngineerDataObjectContext(MyBase.GetEntityConnectionString( _
                "EngineerData", _
                "res://" + assemblyName + "/EngineerData.csdl|res://" + assemblyName + "/EngineerData.ssdl|res://" + assemblyName + "/EngineerData.msl", _
                "System.Data.SqlClient"))
        End Function
        ...
        Protected Overrides Function ConvertType(ByVal outerType As Global.System.Type) As Global.System.Type
            If (outerType Is GetType(Global.EngineerData.Implementation.EngineerRecord)) Then
                Return GetType(Global.HelpDeskDataServiceVB.EngineerRecord)
            End If
            Return MyBase.ConvertType(outerType)
        End Function
    
        Protected Overrides Function ConvertEntity(ByVal outerEntity As Object) As Object
            Dim engineerRecord As Global.EngineerData.Implementation.EngineerRecord = TryCast(outerEntity, Global.EngineerData.Implementation.EngineerRecord)
            If (Not engineerRecord Is Nothing) Then
                Dim result As New Global.HelpDeskDataServiceVB.EngineerRecord
                result.Id = engineerRecord.Id
                result.Surname = engineerRecord.Surname
                result.Firstname = engineerRecord.Firstname
                result.DateOfBirth = engineerRecord.DateOfBirth
                result.SecurityVetted = engineerRecord.SecurityVetted
                Return result
            End If
            Return Nothing
        End Function
        ...
        Protected Overrides Sub UpdateResult(ByVal outerEntity As Object, ByVal innerResult As Object)
            Dim outerEngineerRecord As Global.EngineerData.Implementation.EngineerRecord = TryCast(outerEntity, Global.EngineerData.Implementation.EngineerRecord)
            Dim innerEngineerRecord As Global.HelpDeskDataServiceVB.EngineerRecord = TryCast(innerResult, Global.HelpDeskDataServiceVB.EngineerRecord)
            If ((outerEngineerRecord IsNot Nothing) AndAlso (innerEngineerRecord IsNot Nothing)) Then
                outerEngineerRecord.Id = innerEngineerRecord.Id
                outerEngineerRecord.Surname = innerEngineerRecord.Surname
                outerEngineerRecord.Firstname = innerEngineerRecord.Firstname
                outerEngineerRecord.DateOfBirth = innerEngineerRecord.DateOfBirth
                outerEngineerRecord.SecurityVetted = innerEngineerRecord.SecurityVetted
                outerEngineerRecord.IssueCount = innerEngineerRecord.IssueCount
                Return
            End If
        End Sub
    ...
    Public Class DataServiceFactory
        ...
        Protected Overrides Function CreateDataService(ByVal dataServiceType As Global.System.Type) As Global.Microsoft.LightSwitch.IDataService
            ...
            If dataServiceType.Equals(GetType(Global.LightSwitchApplication.EngineerData)) Then
                Return New Global.LightSwitchApplication.EngineerDataService()
            End If
        ...
        Protected Overrides Function CreateDataServiceImplementation(Of TDataService As Global.Microsoft.LightSwitch.IDataService)(ByVal dataService As TDataService) As Global.Microsoft.LightSwitch.Internal.IDataServiceImplementation
            ...
            If GetType(TDataService).Equals(GetType(Global.LightSwitchApplication.EngineerData)) Then
                Return New Global.LightSwitchApplication.Implementation.EngineerDataServiceImplementation(dataService)
            End If
    ...
    Public Class __TypeMapping
        ...
        Private Function GetImplementationType(ByVal definitionType As Global.System.Type) As Global.System.Type Implements Global.Microsoft.LightSwitch.Internal.ITypeMappingProvider.GetImplementationType
            ...
            If GetType(Global.LightSwitchApplication.EngineerRecord).Equals(definitionType)
                Return GetType(Global.EngineerData.Implementation.EngineerRecord)
            End If
            Return Nothing
        End Function
    End Class
