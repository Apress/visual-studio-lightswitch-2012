        ...
        Private Sub CloseAllIssues_Execute()
            ...
            Dim statusClosed =
               DataWorkspace.ApplicationData.IssueStatusSet.Where(
                   Function(status) status.StatusDescription = "Closed").SingleOrDefault

            'Add the status if it doesn't exist
            If statusClosed Is Nothing Then
            ...
            'Uncomment the line beneath to automatically save changes
            'Me.DataWorkspace.ApplicationData.SaveChanges()
