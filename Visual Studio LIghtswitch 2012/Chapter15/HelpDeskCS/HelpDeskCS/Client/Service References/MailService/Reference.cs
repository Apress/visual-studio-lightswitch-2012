...
namespace LightSwitchApplication.MailService {
    ...
    public interface IMailService {
        ...
        System.IAsyncResult BeginSendMail(string emailTo, string subject, string body, System.AsyncCallback callback, object asyncState);
    ...
    public partial class MailServiceClient : System.ServiceModel.ClientBase<LightSwitchApplication.MailService.IMailService>, LightSwitchApplication.MailService.IMailService {
        ...
        System.IAsyncResult LightSwitchApplication.MailService.IMailService.BeginSendMail(string emailTo, string subject, string body, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSendMail(emailTo, subject, body, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string LightSwitchApplication.MailService.IMailService.EndSendMail(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginSendMail(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((LightSwitchApplication.MailService.IMailService)(this)).BeginSendMail(emailTo, subject, body, callback, asyncState);
        }
        
        private object[] OnEndSendMail(System.IAsyncResult result) {
            string retVal = ((LightSwitchApplication.MailService.IMailService)(this)).EndSendMail(result);
            return new object[] {
                    retVal};
        }
        ...
        public void SendMailAsync(string emailTo, string subject, string body) {
            this.SendMailAsync(emailTo, subject, body, null);
        }
        
        public void SendMailAsync(string emailTo, string subject, string body, object userState) {
        ...
        private class MailServiceClientChannel : ChannelBase<LightSwitchApplication.MailService.IMailService>, LightSwitchApplication.MailService.IMailService {
            ...
            public System.IAsyncResult BeginSendMail(string emailTo, string subject, string body, System.AsyncCallback callback, object asyncState) {
