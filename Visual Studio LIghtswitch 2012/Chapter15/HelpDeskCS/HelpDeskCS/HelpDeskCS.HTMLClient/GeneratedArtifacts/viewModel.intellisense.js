...
(function (lightSwitchApplication) {
    ...
    msls._addEntryPoints(lightSwitchApplication.BrowseUsers, {
        ...
        /// <field>
        /// Called after the AppOptionsTemplate content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        AppOptionsTemplate_postRender: $parameters,
        /// <field>
    ...
    msls._addEntryPoints(lightSwitchApplication.AddEditAppOption, {
        ...
        /// <field>
        /// Called after the EmailFrom1 content item has been rendered.
        /// <br/>postRender(HTMLElement element, msls.ContentItem contentItem)
        /// </field>
        EmailFrom1_postRender: $parameters
    });
