...
myapp.AddEditUser.Group_render = function (element, contentItem) {
    var helpText = $("<div style='padding-bottom:20px;'>" +
     "<ul>" +
     "<li>Enter a valid email address for the user</li>" +
     "<li>Go to the 'Contact User' tab to compose a message</li>" +
     " </ul></div>");
    helpText.prependTo($(element));
};

myapp.AddEditUser.Group1_render = function (element, contentItem) {
    var helpText = $("<div style='padding-bottom:20px;'>" +
