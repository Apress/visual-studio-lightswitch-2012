...
'Original file name:
'Generation date: 13/11/2012 18:49:55
Namespace LightSwitchApplication.Implementation
    '''<summary>
    '''There are no comments for ExternalSQLDataSourceObjectContext in the schema.
    '''</summary>
    Partial Public Class ExternalSQLDataSourceObjectContext
        ...
        End Sub
        <Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")>  _
        Private Shared ROOTNAMESPACE As String = GetType(LightSwitchApplication.Implementation.ExternalSQLDataSourceObjectContext).Namespace.Remove(GetType(LightSwitchApplication.Implementation.ExternalSQLDataSourceObjectContext).Namespace.LastIndexOf("LightSwitchApplication.Implementation"))
        '''<summary>
