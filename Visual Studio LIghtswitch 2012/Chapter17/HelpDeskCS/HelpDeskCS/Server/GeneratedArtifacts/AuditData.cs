...
namespace AuditData.Implementation
{
    #region Contexts
    ...
    /// </summary>
    public partial class AuditDataObjectContext : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new AuditDataObjectContext object using the connection string found in the 'AuditDataObjectContext' section of the application configuration file.
        /// </summary>
        public AuditDataObjectContext() : base("name=AuditDataObjectContext", "AuditDataObjectContext")
        {
            OnContextCreated();
        }
        ...
        /// </summary>
        public AuditDataObjectContext(string connectionString) : base(connectionString, "AuditDataObjectContext")
        {
            OnContextCreated();
        }
        ...
        /// Initialize a new AuditDataObjectContext object.
        /// </summary>
        public AuditDataObjectContext(EntityConnection connection) : base(connection, "AuditDataObjectContext")
        {
            OnContextCreated();
        }
