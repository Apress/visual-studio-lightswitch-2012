...
<Assembly: EdmSchemaAttribute("8d10cf20-069b-4200-83ca-5d8ea3f88477")>
Namespace HRData.Implementation
    ...
    ''' </summary>
    Public Partial Class HRDataObjectContext
        Inherits ObjectContext
    
        #Region "Constructors"
    
        ''' <summary>
        ''' Initializes a new HRDataObjectContext object using the connection string found in the 'HRDataObjectContext' section of the application configuration file.
        ''' </summary>
        Public Sub New()
            MyBase.New("name=HRDataObjectContext", "HRDataObjectContext")
            OnContextCreated()
        End Sub
        ...
        Public Sub New(ByVal connectionString As String)
            MyBase.New(connectionString, "HRDataObjectContext")
            OnContextCreated()
        End Sub
        ...
        Public Sub New(ByVal connection As EntityConnection)
            MyBase.New(connection, "HRDataObjectContext")
            OnContextCreated()
        End Sub
